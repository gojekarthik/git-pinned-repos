...
program
  ...
  .action(() => {
    ...
    fs.copyFileSync(
      path.join(templateDir, 'GithubPinnedRepos.tsx'),
      path.join(currentDir, 'GithubPinnedRepos.tsx')
    );
    console.log('GithubPinnedRepos.tsx has been created in your current directory.');
